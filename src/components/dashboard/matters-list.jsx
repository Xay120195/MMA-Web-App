        ...
        <Link to={`${AppRoutes.MATTERS}/${matter.id}`}>
            <div className="w-full h-42 bg-gray-100 rounded-lg border border-gray-200 mb-6 py-5 px-4">
                <div>
                    ...
                    <p tabIndex="0" className="focus:outline-none text-gray-800 dark:text-gray-100 text-sm">{matter.client_name}</p>
                    <br />
            ...
            <div className="w-full h-42 bg-gray-100 rounded-lg border border-gray-200 mb-6 py-5 px-4">
                <div>
                    <div className="grid grid-cols-4 gap-4">
                        ...
                        <p tabIndex="0" className="focus:outline-none text-xs text-gray-400">{matter.client_name} | {matter.matter_number}</p>
                        </div>
