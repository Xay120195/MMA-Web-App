...
import {addClientMatter, deleteMatterClient, getMatterList, searchMatterClient,} from './actions';
      ...
      <div className="sm:hidden flex flex-row">
        ...
        */}
                <div className="text-right sm:hidden">
                    <h1 id="headerTag" className="text-base py-5 px-3 font-bold">
                        AFFIDAVITS &amp; RFI{' '}
                    </h1>
                </div>
                {/*</div>*/}
                <div
                    className="contentDiv bg-white py-5 sm:p-5 font-sans rounded-lg flex sm:block flex-col"
                ...
                >
                                    ...
                                    <>
                                        ...
                                        <form onSubmit={handleSubmit(handleNewMatter)}>
                                            <div className="grid grid-flow-col grid-cols-3">
                                                <div className="pr-2">
                                                    <div
                                                        className="relative flex w-full flex-wrap items-stretch mt-3 pt-5">
                                                ...
                                                <div className="pr-2">
                                                    <div
                                                        className="relative flex w-full flex-wrap items-stretch mt-3 pt-5">
                                                        <span
                                                            className="z-10 h-full leading-snug font-normal text-center text-blueGray-300 absolute left-3 bg-transparent rounded text-base items-center justify-center w-8 py-3"></span>
                                                        <CreatableSelect
                    ...
                    <div className="flex ">
                        <div className="w-full mb-3 py-5 px-5 sm:px-0">
              <span
                  className="z-10 h-full leading-snug font-normal text-center text-blueGray-300 absolute bg-transparent rounded text-base items-center justify-center w-8 py-3 px-3">
                <IoIcons.IoIosSearch/>
              </span>
                            <input
                                type="search"
                        ...
                        <div className="mb-3 py-5 w-1/6 text-right hidden sm:block flex items-center">
                            {mattersView === 'grid' ? (
                                <button
