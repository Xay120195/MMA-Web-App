      ...
      <div className="sidebar">
        <div className="main-grid">
          <div className="logo-grid">
            ...
            <button>
              <HiChevronDoubleLeft onClick={showSidebar} style={{ color: "var(--mysteryGrey)" }} />
            </button>
          </div>
            ...
            {userInfo &&
              SidebarData.map((item, index) => {
                return (item.name === "DASHBOARD" && showDashboard) ||
                  ...
                  <li className={location.pathname === item.path ? "active-page" : ""} key={index}>
                  ...
                  <li
                    className={location.pathname === item.path ? "active-page" : "hidden sm:block"}
                    key={index}
                  >
                    <Link className="nav-item" to={item.path}>
                      {item.icon}
